...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    .setName("stats-valorant")
    .setDescription("Displays Valorant stats for a specified player")
  ...
  async run({ interaction }) {
    ...
    try {
      ...
      const mmrChange = mmrData?.current_data?.mmr_change_to_last_game ?? "N/A";
      ...
      const embed = new EmbedBuilder()
        ...
        .addFields(
          ...
          { name: "Rank Progress", value: `${rankProgress}/100`, inline: true },
        ...
        .setFooter({
          text: "Data provided by Henrik's Valorant API",
        });
